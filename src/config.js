...
export const ENEMY_CONFIG = {
  ...
  height: 32,
  spawns: [
    { x: 100, y: 100, name: 'red', color: 0xFF0000 },
    { x: 700, y: 100, name: 'pink', color: 0xFF69B4 },
    { x: 100, y: 500, name: 'blue', color: 0x0080FF },
    { x: 700, y: 500, name: 'yellow', color: 0xFFFF00 }
  ]
};
